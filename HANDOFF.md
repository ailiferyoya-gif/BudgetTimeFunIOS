...
- 候補詳細から地図を開ける導線を追加
- 徒歩 / 公共交通の移動手段切替を追加
- 時間・予算が十分な場合に名古屋発の京都・犬山など遠出候補を表示
- 目的地候補から駅・バス停を除外し、店、寺社、公園、市場、美術館など楽しめる場所に限定
- Web プレビューに OpenStreetMap 地図と候補ピンを追加
- Web プレビューに Google Maps の徒歩ルート / 公共交通ルートリンクを追加
...
- 周辺検索の費用・所要時間は概算ロジック
- 公共交通の実運賃と正確な乗換検索は Google Maps / Apple Maps 側へ渡して確認する設計
